...
$EM_CONF[$_EXTKEY] = array(
	'title' => 'Shop System',
	'description' => '"Der TYPO3 Webshop" at opensourcepress.de - Shop with listing in multiple languages, with order tracking, photo gallery, DAM, product variants, credit card payment and bank accounts, bill, creditpoint, voucher system and gift certificates. Latest updates at ttproducts.de.',
	'category' => 'plugin',
	'shy' => 0,
	...
	'constraints' => array(
		...
		'suggests' => array(
			'party' => '',
			'pmkhtmlcrop' => '',
			'static_info_tables' => '2.0.9-',
			'static_info_tables_taxes' => '0.1.0-',
			'taxajax' => '0.2.7-',
			'transactor' => '0.2.0-',
		),
	),
