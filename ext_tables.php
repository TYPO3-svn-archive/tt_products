...
t3lib_extMgm::addStaticFile(TT_PRODUCTS_EXTkey, 'static/int/', 'Shop System Variable Content');

if (t3lib_extMgm::isLoaded('searchbox')) {
	t3lib_extMgm::addStaticFile(TT_PRODUCTS_EXTkey, 'static/searchbox/', 'Shop System Search Box');
}
...
if ($GLOBALS['TYPO3_CONF_VARS']['EXTCONF'][TT_PRODUCTS_EXTkey]['articleMode'] == '2')	{
	$TCA['tt_products_products_mm_articles'] = Array (
		'ctrl' => Array (
			'title' => 'LLL:EXT:'.TT_PRODUCTS_EXTkey.'/locallang_db.xml:tt_products_products_mm_articles',
			'label' => 'uid_local',
			'tstamp' => 'tstamp',
			'delete' => 'deleted',
			'enablecolumns' => Array (
...
if (
	...
	t3lib_extMgm::addPiFlexFormValue('5', 'FILE:EXT:'.TT_PRODUCTS_EXTkey.'/pi1/flexform_ds_pi1.xml');
	...
	if (t3lib_extMgm::isLoaded('searchbox')) {
		...
		t3lib_extMgm::addPiFlexFormValue($listType, 'FILE:EXT:'.TT_PRODUCTS_EXTkey.'/pi_search/flexform_ds_pi_search.xml');
		t3lib_extMgm::addPlugin(Array('LLL:EXT:'.TT_PRODUCTS_EXTkey.'/pi_search/locallang_db.xml:tt_content.list_type_pi_search', $listType),'list_type');
	}

	$listType = TT_PRODUCTS_EXTkey.'_pi_int';
	$TCA['tt_content']['types']['list']['subtypes_excludelist'][$listType]='layout,select_key';
	$TCA['tt_content']['types']['list']['subtypes_addlist'][$listType]='pi_flexform';
	t3lib_extMgm::addPiFlexFormValue($listType, 'FILE:EXT:'.TT_PRODUCTS_EXTkey.'/pi_int/flexform_ds_pi_int.xml');
	t3lib_extMgm::addPlugin(Array('LLL:EXT:'.TT_PRODUCTS_EXTkey.'/pi_int/locallang_db.xml:tt_content.list_type_pi_int', $listType),'list_type');
}
...
t3lib_extMgm::addToInsertRecords('tt_products_products_mm_articles');
...
t3lib_extMgm::allowTableOnStandardPages('tt_products_products_mm_articles');
...
$tempColumns = Array (
	...
	'tt_products_memodam' => Array (
		'exclude' => 1,
		'label' => 'LLL:EXT:'.TT_PRODUCTS_EXTkey.'/locallang_db.xml:fe_users.tt_products_memodam',
		'config' => Array (
			'type' => 'input',
			'size' => '50',
			'max' => '256'
...
t3lib_extMgm::addToAllTCAtypes('fe_users','tt_products_creditpoints;;;;1-1-1,tt_products_vouchercode;;;;1-1-1,tt_products_memoItems;;;;1-1-1,tt_products_memodam;;;;1-1-1,tt_products_discount;;;;1-1-1,tt_products_vat;;;;1-1-1');
...
if (TYPO3_MODE=="BE")	{
	...
	t3lib_extMgm::insertModuleFunction(
		...
		'LLL:EXT:'.TT_PRODUCTS_EXTkey.'/locallang.xml:moduleFunction.tx_ttproducts_modfunc1',
		'wiz'
	);
}
