...
class tx_ttproducts_pi1 {
	...
	public function main ($content,$conf)	{
		...
		if ($conf['templateFile'] != '')	{
			...
			tx_div2007_alpha5::loadLL_fh002($pibaseObj, 'EXT:' . TT_PRODUCTS_EXTkey . '/pi1/locallang.xml');
	...
	public function getUserFunc ($content,$conf)	{
		...
		if (is_array($GLOBALS['TYPO3_CONF_VARS']['EXTCONF'][TT_PRODUCTS_EXTkey]['getUserFunc'])) {
			foreach($GLOBALS['TYPO3_CONF_VARS']['EXTCONF'][TT_PRODUCTS_EXTkey]['getUserFunc'] as $classRef) {-
