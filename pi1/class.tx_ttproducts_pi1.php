...
class tx_ttproducts_pi1 extends fhlibrary_pibase {
	...
	function init (&$content,&$conf, &$config) {
		...
		if (t3lib_extMgm::isLoaded('xajax')) {
			include_once(t3lib_extMgm::extPath('xajax').'xajax.inc.php');
			$this->xajax = t3lib_div::makeInstance('xajax');
			$this->xajax->registerFunction('showArticle');
		}
		...
		$this->javascript->init($this, $this->conf, $this->config, $this->page);
	...
	function initTables()	{		
		...
		$this->tt_products_articles->init($this,$this->LLkey, $this->conf['table.']['tt_products_articles'],$this->conf['table.']['tt_products_articles.']);	
