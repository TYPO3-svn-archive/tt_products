...
$TCA['tt_products'] = Array (
	...
	'types' => Array (
		'0' => Array('showitem' => 'title;;5;;3-3-3, itemnumber;;3, category, address, price;;4,weight;;6, note;;;richtext[]:rte_transform[mode=ts_css|imgpath=uploads/tx_ttproducts/rte/], note2;;;richtext[]:rte_transform[mode=ts_css|imgpath=uploads/tx_ttproducts/rte/],note_uid;;;;1-1-1,image;;;;4-4-4,datasheet;;;;1-1-1,hidden;;1,' .
				...
				'--div--;LLL:EXT:tt_products/locallang_db.xml:tt_products.relations,related_uid,'.
...
$TCA['tt_products_cat'] = Array (
	...
	'interface' => Array (
		'showRecordFieldList' => 'hidden,starttime,endtime,fe_group,title, subtitle, note, image, email_uid'
	),
...
$TCA['sys_products_cards'] = Array (
	...
	'interface' => Array (
		'showRecordFieldList' => 'cc_number,cc_type'
	),
	...
	'types' => Array (
		'1' => Array('showitem' => 'hidden;;;;1-1-1, cc_number, cc_type')
	),
	'palettes' => Array (
		'1' => Array('showitem' => '')
	)
...
$TCA['sys_products_orders'] = Array (
	...
	'interface' => Array (
		'showRecordFieldList' => 'hidden,name,first_name,last_name,salutation,address,zip,country,telephone,email,fax,payment,shipping,amount,email_notify,tracking_code,status,agb,feusers_id,creditpoints,creditpoints_spended,creditpoints_saved,creditpoints_gifts,desired_date,client_ip,note,cc_uid'
	),
	...
	'columns' => Array (
		...
		'client_ip' => Array (
			'exclude' => 1,
			'label' => 'LLL:EXT:tt_products/locallang_db.xml:sys_products_orders.client_ip',
			'config' => Array (
				'type' => 'input',
				'size' => '15',
				'max' => '15',
	...
	'types' => Array (
		'1' => Array('showitem' => 'hidden;;;;1-1-1, name;;3;;3-3-3, first_name,last_name,salutation,address,zip,country,telephone,email,payment,shipping,amount,email_notify,tracking_code,status,fax,agb,feusers_uid,creditpoints,creditpoints_spended,creditpoints_saved,creditpoints_gifts,desired_date,client_ip,note,cc_uid')
	),
	'palettes' => Array (
		'1' => Array('showitem' => 'starttime, endtime, fe_group'),
	)
