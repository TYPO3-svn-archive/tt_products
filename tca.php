...
$TCA['tt_products'] = Array (
	...
	'types' => Array (
		'0' => Array('showitem' => 'title;;5;;3-3-3, itemnumber;;2, category, address, price;;3,graduated_price_uid,offer;;4;;3-3-3,weight;;6,hidden;;1,' .
	...
	'palettes' => Array (
		...
		'3' => Array('showitem' => 'price2,directcost,tax_id,creditpoints'),
		'4' => Array('showitem' => 'highlight,bargain'),
...
if (t3lib_extMgm::isLoaded('static_info_tables_taxes') && t3lib_extMgm::isLoaded('div2007')) {
...
if (!$bSelectTaxMode) {
	...
	$TCA['tt_products']['palettes']['3']['showitem'] = str_replace(',tax_id,', ',tax,',$TCA['tt_products']['palettes']['3']['showitem']);
}
