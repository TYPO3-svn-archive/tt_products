...
//			$bUseTaxFromShopping = true;
	...
	public function getResellerPrice ($row, $tax=1, $priceNo='')	{
		...
		if (
			...
			!t3lib_utility_Math::canBeInterpretedAsInteger($priceNo) :
	...
	public function getPriceTaxArray ($fieldname, $row)	{
		global $TSFE;
